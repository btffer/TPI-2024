...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2024 a las 06:41:18
...
('axel', '1234', 'a@gmail.com', 23456789, 1),
('axel2', '1234', 'alangamer@gmail.com', 12345678, 2);
...
('axel2', 'alangamer@gmail.com', 12345678);
...
--
ALTER TABLE `nota`
  MODIFY `nota_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
